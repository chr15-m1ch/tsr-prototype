...
# we using some traffic sign images to create a traffic sign detector model

path = "trafficSignDataset" # folder with all the class folders
labelFile = 'trafficSignDatasetLabels.csv' # file with all names of classes
...
# save the model
model.save('trafficSignDetector.p')